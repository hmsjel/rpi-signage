...
def hent_diskplads():
    ...
    try:
        ...
        total, brugt, ledig = shutil.disk_usage("/")

        total_gb = total / (1024 ** 3)
        brugt_gb = brugt / (1024 ** 3)
        ledig_gb = ledig / (1024 ** 3)
        ...
        return {
            ...
            "brugt": round(brugt_gb, 1),
            "ledig": round(ledig_gb, 1),
            "brugt_procent": round(
                brugt_procent,
                1
            )
